...
Επίσης, θα πάρουμε σαν έξτρα υποπεριπτώσεις την χρήση ή όχι συνάρτησης διαχείρισης των outliers, μία περίπτωση για διαχείρηση outliers στο σύνολο των δεδομένων και ένα ακόμα ανά στήλη.
